...
SpaceWireIFOverIPServer::SpaceWireIFOverIPServer(unsigned int newipportnumber) : SpaceWireIF(), ipportnumber(newipportnumber){
...
SpaceWireAsynchronousStatus SpaceWireIFOverIPServer::asynchronousReceive() throw(SpaceWireException){ return *(new SpaceWireAsynchronousStatus); }
SpaceWireAsynchronousStatus SpaceWireIFOverIPServer::asynchronousSend(vector<unsigned char>* packet)	throw(SpaceWireException){ return *(new SpaceWireAsynchronousStatus); }
void SpaceWireIFOverIPServer::waitCompletionOfAsynchronousOperation(SpaceWireAsynchronousStatus status) throw(SpaceWireException){}
