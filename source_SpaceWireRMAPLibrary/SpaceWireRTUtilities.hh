#ifndef SPACEWIRERTUTILITIES_HH_
#define SPACEWIRERTUTILITIES_HH_

class SpaceWireRTUtilities {
public:
...
public:
	static unsigned int calcCRC16(unsigned char *data, unsigned int length);
};

#endif /*SPACEWIRERTUTILITIES_HH_*/
